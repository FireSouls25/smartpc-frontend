/**
 * "Bounce Sidebar" by Rare UI (rareui.com/components/bouncesidebar).
 * Free to use and modify (personal + commercial); attribution appreciated.
 *
 * Adaptation for this Vite + Svelte app (no Next.js):
 * - next/link  →  plain <a> via motion.a for href items.
 * - Rendered inside Svelte through shared/ReactIsland.svelte.
 */
import {
  useEffect,
  useLayoutEffect,
