...
export const en: Record<I18nKey, string> = {
  ...
  "voice.model": "Model",
  "voice.sttModel": "Recognition model",
  "voice.serverDefault": "Server default",
  "voice.sttHint":
    "tiny is fast; base/small cope better with noise. First use downloads it.",
  "voice.sensitivity": "Sensitivity",
  "voice.sensLow": "Low",
  "voice.sensMedium": "Medium",
  "voice.sensHigh": "High",
  "voice.sensHint":
