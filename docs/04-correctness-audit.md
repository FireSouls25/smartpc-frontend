...
✅ Fixed 2026-09-18 (P3 #20): `nativeTheme.shouldUseDarkColors` picks the
matching `--bg` at window creation (correct for the default `auto` mode).

## L4 — Bounce dot misaligns on language switch

✅ Fixed 2026-09-18: the Svelte port's positioning effect tracks the item
list, so label changes re-seat the dot (P2 #15).
